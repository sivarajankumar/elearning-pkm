...
<tr>
    <td height="124" align="center" valign="top"><table width="1056" border="0" align="center" cellspacing="0">
            <tr>
                        ...
                        <tr>
                            <td><form name="form1" method="post" action="login">
                                    <table width="222" border="0">
                                        ...
                                        <tr>
                                            <td><a href="admin_manajemen_guru.jsp">Manajemen User </a></td>
                                        </tr>
                                    </table>
                                </form>                    </td>
                        </tr>
                ...
                <td width="7"><p>&nbsp;</p>
                    ...
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>                </td>
                <td width="809" align="center" valign="top">&nbsp;</td>
            </tr>
</table></td>
</tr>
</table>
