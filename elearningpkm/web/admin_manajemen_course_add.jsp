            ...
            <tr>
                <td width="1061" height="124"><img src="logo2.png" width="1060" height="167">
                    <table width="1053" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <th width="815" bgcolor="#FFFFFF" scope="col"><div align="left"><a href="home">Home</a> &gt;&gt; <a href="admin_manajemen_course.jsp">Manajemen Course </a>&gt;&gt; <a href="admin_manajemen_course_add.jsp">Detil </a></div></th>
                        ...
                        <th width="42" valign="middle" bgcolor="#FFFFFF" scope="col"><span class="style15"><a href="logout">(logout)</a></span></th>
            </tr>
        </table></td>
</tr>
<tr>
...
<tr>
    <td colspan="2"><form action="" method="post" enctype="multipart/form-data" name="form2">
            <table width="883" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="105" scope="col"><div align="center" class="style18">Title</div></td>
                    <td width="94" scope="col"><div align="center" class="style18">Date Modified </div></td>
                    <td width="585" scope="col"><div align="center" class="style18">Body</div></td>
                    <td width="53" scope="col"><span class="style18"></span></td>
                    <td width="46" scope="col"><div align="center"><span class="style17"><span class="style16"><span class="style18"></span></span></span></div></td>
                </tr>
    ...
    <td colspan="2"><form action="" method="post" enctype="multipart/form-data" name="form2">
            <table width="884" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="124" scope="col">File</td>
