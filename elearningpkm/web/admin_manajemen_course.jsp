...
-->
    ...
    <table width="1060" border="0" align="center" cellspacing="0" bordercolor="#CCCCCC">
          <tr>
            <td width="1058" height="124"><img src="header.jpg" width="1053" height="120" align="absmiddle">
              <table width="1053" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <th width="803" bgcolor="#FFFFFF" scope="col"><div align="left"><a href="home_admin.jsp">Home</a> &gt;&gt; <a href="admin_manajemen_course.jsp">Manajemen Course </a></div></th>
                ...
                <td width="860" align="center" valign="top"><table width="856" border="0">
                  <tr>
                    <td width="850"><table width="852" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <th width="852" bgcolor="#0066FF" scope="col"><div align="left">Daftar Course </div></th>
                      </tr>
                      <tr>
