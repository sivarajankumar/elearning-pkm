          ...
          <tr>
            <td width="1061" height="124"><img src="logo2.png" width="1060" height="167">
              <table width="1053" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <th width="815" bgcolor="#FFFFFF" scope="col"><div align="left"><a href="home_siswa.jsp">Home</a> &gt;&gt; <a href="siswa_mycourse.jsp">MyCourse </a>&gt;&gt; <a href="admin_manajemen_course_add.jsp">Detil </a></div></th>
                  ...
                  <tr>
                    <td width="222"><form name="form1" method="post" action="login">
                      <table width="161" border="0">
                        ...
                        <tr>
                          <td><a href="siswa_mycourse.jsp">MyCourse</a><a href="admin_manajemen_guru.jsp"></a></td>
                        </tr>
                      </table>
                                        </form>                    </td>
                  </tr>
                ...
                <td width="1235" align="left" valign="top"><table width="883" border="0">
                  ...
                  <table width="880" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <th width="410" bgcolor="#80BFBF" scope="col"><div align="right"></div></th>
                    </tr>
                    <tr>
                      <td colspan="2"><form action="" method="post" enctype="multipart/form-data" name="form2">
                          <table width="883" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td width="684" bgcolor="#CCCCCC" scope="col"><div align="center" class="style18">Body</div></td>
                            </tr>
                  ...
                  <table width="800" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <th width="329" bgcolor="#80BFBF" scope="col"><div align="right"></div></th>
                    </tr>
                    <tr>
                      <td colspan="2"><form action="" method="post" enctype="multipart/form-data" name="form2">
                          <table width="883" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td width="218" scope="col"><div align="center">File</div></td>
                            </tr>
                            <tr>
                              <td>&nbsp;</td>
                              <td>&nbsp;</td>
