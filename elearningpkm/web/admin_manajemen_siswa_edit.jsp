...
-->
    ...
    <table width="1024" border="0" align="center" cellspacing="0" bordercolor="#CCCCCC">
          <tr>
            <td height="124"><img src="logo2.png" width="1056" height="180">
              <table width="1053" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <th width="803" bgcolor="#FFFFFF" scope="col"><div align="left"><a href="home_admin.jsp">Home</a> &gt;&gt; <a href="admin_manajemen_siswa.jsp">Manajemen Siswa </a>&gt;&gt; <a href="admin_manajemen_siswa_edit.jsp">Edit </a></div></th>
                ...
                <td width="813" align="center" valign="top"><table width="815" border="0">
                  <tr>
                    <td width="669"><table width="814" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <th width="814" bgcolor="#80BFBF" scope="col"><div align="left">Edit Data  Siswa </div></th>
                      </tr>
                      <tr>
                        <td><form action="" method="post" enctype="multipart/form-data" name="form2">
                          <table width="814" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              <td scope="col"><div align="left"><span class="style16">Nomor Identitas Siswa </span></div></td>
