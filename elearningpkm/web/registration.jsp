          ...
          <tr>
            <td height="124" align="center" valign="top"><form name="form1" method="post" action="">
              <table width="1053" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td colspan="8" bgcolor="#0099CC"><p>Registration Form </p>
                  </td>
                </tr>
                <tr>
                  <td width="131" bgcolor="#00CCFF">Identity Number </td>
                  <td width="16" bgcolor="#00CCFF">:</td>
                  <td colspan="6" bgcolor="#00CCFF"><label>
                ...
                <tr>
                  ...
                  <td width="16" bgcolor="#00CCFF">:</td>
                  <td colspan="3" bgcolor="#00CCFF"><label for="label4"></label>
                ...
                <tr>
                  ...
                  <td bgcolor="#00CCFF">:</td>
                  <td colspan="3" bgcolor="#00CCFF"><label for="textfield"></label>
                ...
                <tr>
                  ...
                  <td colspan="2" bgcolor="#00CCFF">School Name </td>
                  <td bgcolor="#00CCFF">&nbsp;</td>
                  <td colspan="3" bgcolor="#00CCFF"><label for="label5"></label>
                ...
                <tr>
                  <td bgcolor="#00CCFF">&nbsp;</td>
                  <td bgcolor="#00CCFF">&nbsp;</td>
                  <td colspan="6" bgcolor="#00CCFF">&nbsp;</td>
                </tr>
                <tr>
                  <td bgcolor="#00CCFF">&nbsp;</td>
                  <td bgcolor="#00CCFF">&nbsp;</td>
                  ...
                  <td width="56" bgcolor="#00CCFF"><label>
                    <div align="right">
                      <input type="submit" name="Submit" value="Submit">
                    </div>
                  </label></td>
                  <td width="547" bgcolor="#00CCFF">&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
